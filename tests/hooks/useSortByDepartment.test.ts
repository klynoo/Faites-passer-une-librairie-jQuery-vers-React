...
import useSortByDepartment from "../../src/hooks/useSortByDepartment"

describe("useSortByDepartment", () => {
  it("tri par défaut en ordre ascendant (department)", () => {
    const { result } = renderHook(() => useSortByDepartment())
